...
namespace MtgDecklistsCdk
{
    sealed class Program
    {
        ...
        public static readonly string DecklistApiAotImageTag  = "DecklistApi.Web.Aot-12";
        public static readonly string DecklistWebsiteVersion  = "v1.0.6";
        public static readonly string ScryfalllReaderImageTag = "DecklistApi.ScryfallReader-2";
