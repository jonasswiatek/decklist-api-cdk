...
namespace MtgDecklistsCdk
{
    sealed class Program
    {
        ...
        public static readonly string DecklistApiAotImageTag  = "DecklistApi.Web.Aot-14";
        public static readonly string DecklistWebsiteVersion  = "v1.0.13";
        public static readonly string ScryfalllReaderImageTag = "DecklistApi.ScryfallReader-5";
